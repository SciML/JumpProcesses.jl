...
"""
function flatten(ma_jump, prob::DiscreteProblem,
        spatial_system, hopping_constants;
        kwargs...)
    tspan = prob.tspan
    u0 = prob.u0
    if ma_jump === nothing
    ...
    flatten(netstoch, reactstoch, rx_rates, spatial_system, u0, tspan,
        hopping_constants;
...
function flatten(netstoch::AbstractArray, reactstoch::AbstractArray,
    ...
    flatten(netstoch, reactstoch, rx_rates, spatial_system,
        u0, tspan, hop_constants;
        kwargs...)
end
...
function flatten(netstoch::AbstractArray, reactstoch::AbstractArray,
    ...
    flatten(netstoch, reactstoch, rates, spatial_system,
        u0, tspan, hopping_constants;
        kwargs...)
end
...
function flatten(netstoch::Vector{R}, reactstoch::Vector{R}, rx_rates::Matrix{F},
    ...
    ma_jump = MassActionJump(total_rates, total_reactstoch, total_netstoch;
        nocopy = true,
