...
# Solve with SimpleImplicitTauLeaping
alg = SimpleImplicitTauLeaping()
sol = solve(jump_prob, alg; saveat=0.1)
...
alg_newton = SimpleImplicitTauLeaping(epsilon=0.05, solver=NewtonImplicitSolver())
sol_newton = solve(jump_prob, alg_newton)

alg_trapezoidal = SimpleImplicitTauLeaping(epsilon=0.05, solver=TrapezoidalImplicitSolver())
