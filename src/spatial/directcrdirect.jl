...
function aggregate(aggregator::DirectCRDirect, starting_state, p, t, end_time,
        constant_jumps,
        ma_jumps, save_positions, rng; hopping_constants,
    ...
    DirectCRDirectJumpAggregation(next_jump, next_jump_time, end_time, rx_rates, hop_rates,
        site_rates,
        save_positions, rng, spatial_system;
...
function execute_jumps!(p::DirectCRDirectJumpAggregation,
        integrator, u, params, t,
        affects!)
    # execute jump
...
"""
function fill_rates_and_get_times!(aggregation::DirectCRDirectJumpAggregation,
        integrator, t)
