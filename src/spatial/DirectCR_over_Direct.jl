# site chosen with DirectCR, reaction or hop chosen with Direct


############################ DirectCR_over_Direct or DCRD ###################################
...
mutable struct DCRDJumpAggregation{J,T,RX,HOP,RNG,DEPGR,VJMAP,JVMAP,PQ,SS} <: AbstractSSAJumpAggregator
